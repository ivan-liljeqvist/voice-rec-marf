...
::
:: Copyright (C) 2003 - 2012 The MARF Research and Development Group
::
:: Serguei Mokhov
:: Shuxin Fan
::
:: $Header: /cvsroot/marf/apps/SpeakerIdentApp/testing.bat,v 1.18 2012/01/09 04:03:22 mokhov Exp $
::
...
:RETRAIN
	...
	:: Preprocessing
	echo for %%%%p in (-norm -boost -low -high -band -highpassboost -raw -endp -lowcfe -highcfe -bandcfe -bandstopcfe) do call tmp-feat-train.bat %%%%p > tmp-prep-train.bat
...
:TESTING
	...
	:: Preprocessing
	echo for %%%%p in (-norm -boost -low -high -band -highpassboost -raw -endp -lowcfe -highcfe -bandcfe -bandstopcfe) do call tmp-feat-ident.bat %%%%p > tmp-prep-ident.bat
