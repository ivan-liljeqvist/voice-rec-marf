...
# Serguei Mokhov
#
# COPYRIGHT (c) 2002 - 2012 The MARF Research Development Group
#
# $Header: /cvsroot/marf/apps/SpeakerIdentApp/Makefile,v 1.36 2012/01/09 04:03:22 mokhov Exp $
#
...
JAVAC = javac
CLASSPATH = ".:$(MARFJAR)"
JFLAGS = -g -source 1.5 -verbose -deprecation -classpath $(CLASSPATH) -extdirs ".:$(MARFJAR)" -sourcepath .
JVM = java
...
run test-run:
	@echo "'make run' or 'make test-run' are ambiguous. Use 'make train-run' or 'make ident-run' instead."
...
DISTROSRCFILES = \
	$(JAVAFILES) \
	SpeakerIdentApp SpeakerIdentApp.bat testing.sh testing.bat retrain.lnk \
